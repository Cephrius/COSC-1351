...
class Room(object):
    ...
    #adds grabbalbe item to the room 
...
class Game(Frame):
    ...
    def createRooms(self):
        ...
        r2 = Room("Room 2","room1.gif")
        r3 = Room("Room 3","room1.gif")
        ...
        r2.addItem("fireplace", " is not lit up")
    ...
    def setStatus(self,status):
        ...
        if (Game.currentRoom == None):
            ...
            Game.text.insert(END, "You are dead. The only thing you can do now is quiz.\n")
        else:
        ...
        if len(words) == 2: 
            ...
            if verb == "go":
                ...
                # the verb is look
                    ...
                    for grabbable in Game.currentRoom.grabables:
                        ...
                        if noun == grabbable:
                            ...
                            break
        # displat the response on the right of the GUI
